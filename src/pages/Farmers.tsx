...
const Farmers = () => {
  ...
  const allCertifications = Array.from(
    new Set(farmersList.flatMap(farmer => farmer.certifications))
  );
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-4 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 justify-center md:justify-end">
              <Badge 
                className={`cursor-pointer ${selectedCertification === "" ? "bg-farm-green" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}
              ...
              {allCertifications.map(cert => (
                <Badge 
                  key={cert}
                  className={`cursor-pointer ${selectedCertification === cert ? "bg-farm-green" : "bg-gray-200 text-gray-800 hover:bg-gray-300"}`}
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {filteredFarmers.map(farmer => (
              <div key={farmer.id} className="farm-card h-full flex flex-col overflow-hidden">
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  <div className="mb-4">
                    {farmer.certifications.map(cert => (
                      <Badge key={cert} className="mr-2 mb-2 bg-farm-cream text-farm-brown-dark">
                        {cert}
                      </Badge>
                    ))}
                  </div>
